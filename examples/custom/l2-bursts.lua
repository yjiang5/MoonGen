...
function master(...)
	...
	if txDev:getPciId() ~= device.PCI_ID_X710 and txDev:getPciId() ~= device.PCI_ID_XL710 then
		errorf("Invalid NIC")
	end
	txDev:wait()
	dpdk.launchLua("burstGenSlave", txPort, 250/50, 5000/50, 6700, 67) -- TODO: consider using command line args here
